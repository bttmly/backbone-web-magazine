...
App.templates = {
  dropdown: CoffeeKup.compile(function() {
    ...
    div({
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        _results.push(div({
          ...
          a({
            "class": 'article-link',
            href: "/backbone-web-magazine/article/" + article.uid
          }, function() {
            return h2({
              "class": 'snippet-title'
            }, function() {
              ...
              for (i = _j = 0, _len1 = _ref1.length; _j < _len1; i = ++_j) {
                ...
                _results1.push(span({
                  ...
                  if (i === article.authors.length - 1) {
                    return "<a href='/backbone-web-magazine/author/" + author + "'>" + author + "</a>";
                  } else if (i === article.authors.length - 2) {
                    return "<a href='/backbone-web-magazine/author/" + author + "'>" + author + "</a> and ";
                  } else {
                    return "<a href='/backbone-web-magazine/author/" + author + "'>" + author + "</a>, ";
                  }
                }));
    ...
    return footer({
      ...
      var url;
      url = data.category === "featured" ? "/backbone-web-magazine/" : "/backbone-web-magazine/category/" + data.category;
      return a({
        "class": 'category-link',
        href: url
      }, function() {
    ...
    return article(function() {
      header({
        ...
        div({
          ...
          a({
            "class": 'article-link',
            href: "/backbone-web-magazine/article/" + art.uid
          }, function() {
            return h2({
              "class": 'article-title'
            }, function() {
